...
function randomize(rom, rng, opts) {
	...
	for ( let i = 0; i < 15; i+=1)
	{
		...
		rom[(scenarioOneEnemy[1][0]+(i*8))]=Math.floor( rng() % 12);  //level
		rom[(scenarioOneEnemy[2][0]+(i*8))]=fullEnemyMechs[Math.floor( rng() * fullEnemyMechs.length)]; //mechs
		rom[(scenarioOneEnemy[3][0]+(i*8))]=Math.floor( rng() % 5 ); // turns until activation
//		rom[(scenarioOneEnemy[4][0]+(i*8))]=Math.floor( rng() * 23 ); // x position
//		rom[(scenarioOneEnemy[5][0]+(i*8))]=Math.floor( rng() * 23 ); // y position
...
//		rom[(scenarioOneEnemy[3][1]+(i*8))]=Math.floor( rng() % 5 ); // turns until activation
...
//		if ( i != 0 ) {	
//			rom[(scenarioOneAlly[6][0]+((i*3)-1))]=v;
//		}
//		rom[(scenarioOneAlly[1][0]+(i*4))]=Math.floor( rng() % 8); //level
...
//	rom[scenarioOneAlly[5][0]]=Math.floor(rng()*23); // y position
	...
	{
//		rom[(scenarioOneAlly[4][0]+((i*3)-1))]=Math.floor(rng()*23); // x position
//		rom[(scenarioOneAlly[5][0]+((i*3)-1))]=Math.floor(rng()*23); // y position
//		rom[(scenarioOneAlly[6][0]+((i*3)-1))]=rom[scenarioOneAlly[0][0]+i*4];
	}

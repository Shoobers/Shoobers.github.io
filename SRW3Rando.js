function randomize(rom, rng, opts, log) {
	...
	//scenario 1
	randSplit[2]=setAllyAreaSquare(randSplit[2], 15, 0, 22, 10);
	...
	randSplit = allyRandomize(randSplit[1], 11, 1, scenarioOneAlly, pilotList, spaceAllyMechs, randSplit[0], rng, randSplit[2], 1, 8, 22, 23);	// scenario 1 ally spawn
